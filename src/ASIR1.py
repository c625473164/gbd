...
bc = pd.read_csv('./data/raw/breast_cancer.csv')
...
bc1 = bc[(bc['year'] == y)& (bc['measure_name'] == measure_name) & (bc['sex_name'] == sex) & (bc['age_name'] == age) & (bc['metric_name'] == m) & (bc['location_name'] == location)]
